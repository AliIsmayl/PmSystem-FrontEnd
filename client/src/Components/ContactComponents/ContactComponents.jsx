    ...
    >
      <div className="containerContactBox">
        ...
        <div className="leftBox" data-aos="fade-right" data-aos-duration="1000">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3038.0517443662766!2d49.8577419758269!3d40.407704471441065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x403087a9f8397a0b%3A0xf214b7c81735e508!2sPM%20Systems%20LLC%20-%20Project%20Management%20Systems!5e0!3m2!1saz!2saz!4v1722495576696!5m2!1saz!2saz"
            frameBorder="0"
          ></iframe>
        </div>
        <div className="rightBox" data-aos="fade-left" data-aos-duration="1000">
          ...
          <ul>
            <li onClick={handleChangeIpnut}>
              <h3>{t("Customer")}</h3>
              <span className={`${changeForm ? "linesss" : ""}`}></span>
            </li>
            <li onClick={handleChangeIpnut}>
              <h3>{t("Businness")}</h3>
              <span className={`${changeForm ? "" : "linesss"}`}></span>
          ...
          <div className="chanegInputBox">
            <form
              ...
              action=""
              className={`customerForm ${changeForm ? "close" : ""}`}
            >
            ...
            <form
              onSubmit={handleSubmitBusinness}
              action=""
              className={`businessForm ${changeForm ? "open" : ""}`}
            >
              <div className="smallBoxs">
                <div className="smallBox">
                  <label htmlFor="">
                ...
                >
                  ...
                  {service.length > 0 ? (
                    service.map((item) => (
                      <option
                        key={item.id}
                        value={item[languageKey].LittleHeadName}
                      >
